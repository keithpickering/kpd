...
# also create a file called 'category-index.html' in the _layouts directory of your jekyll site
...
module Jekyll
  ...
  class CategoryIndex < CategoryPage
    ...
    def initialize(site, base, category_dir, category)
      template_path = File.join(base, '_layouts', 'category-index.html')
  ...
  class Site
    ...
    def write_category_indexes
      ...
      # Throw an exception if the layout couldn't be found.
        ...
        throw "No 'category-index' layout found."
      end
    end
